# Live forex report — 2026-08-31

Window: 2026-06-03 → 2026-08-21 (11 realizable signal weeks; the newest signal has no realized 5d return yet).
...
- Mean CS-RIC: **-0.0712** (SE ≈ 0.1261), positive weeks: 6/11
...
- Live closed-trade PnL across both demo accounts: **-65.24 USD** on 2000 (-3.26%).
  ...
  - Current account 438689 (from Aug 14): +4.28 USD closed, 6 positions still open.
  - Floating P&L on those open positions: +16.41 USD; balance 2002.72, equity 2019.24 (snapshot 2026-08-31T16:38:38).
- Of which manual-entry fumbles (opened and closed within minutes): -0.96 USD across 7 trades.
- Paper strategy (signal followed exactly, h=5 windows, 1/6 equal weight, 3 bps/side): **-2.76%** cumulative simple sum of weekly net returns.

## Honesty notes

- 11 weekly observations: portfolio Sharpe/return over this window is statistically uninformative (SE of annualized Sharpe ≈ ±2.2). It is deliberately not reported. The IC row count (15 pairs × weeks) is the only metric here with any power.
